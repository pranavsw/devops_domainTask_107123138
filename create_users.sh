...
while IFS=, read -r username group permission; do
    ...
    # I used tee command to add the echo message through pipeline to the Readme file
    echo "Welcome, $username! We are more than happy to see you here and Happy Coding ;)." | sudo tee "/home/$username/projects/README.md" > /dev/null
